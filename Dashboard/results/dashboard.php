...
?>
                        ...
                        <p class="text-light">Total Classes Listed</p>
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <?php 
$sql1 ="SELECT ID from stnsubjects ";
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <?php 
$sql1 ="SELECT id from stnstudents";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalteacher=$query1->rowCount();
?>
                        ...
                        <p class="text-light">Registered Students</p>
            ...
            <div class="col-sm-6 col-lg-6">
                <div class="card text-white bg-flat-color-5">
                    <div class="card-body pb-0">
                        ...
                        <?php 
$sql1 ="SELECT  distinct StudentId from  stnresult ";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalteacher=$query1->rowCount();
?>
                        ...
                        <p class="text-light">Results Declared</p>
