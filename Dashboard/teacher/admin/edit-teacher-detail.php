...
if (!isset($_SESSION['trmsaid']) || strlen($_SESSION['trmsaid']) == 0) {
...
<div class="form-group"><label for="city" class=" form-control-label">Nationality</label>
   <select id="nationality" name="nationality" class="form-control" required>
        ...
        <option value="<?php  echo $row->nationality;?>">Nepal</option>
        <option value="<?php  echo $row->nationality;?>">India</option>
        <option value="<?php  echo $row->nationality;?>">Other</option>
    </select>
</div>
</div>
</div>
...
<div class="row form-group">
<div class="col-12">
<div class="form-group"><label for="city" class=" form-control-label">Joining Date</label><input type="text" placeholder="YYYY-MM-DD" name="joiningdate" id="joiningdate" value="<?php  echo $row->JoiningDate;?>" class="form-control" required="true"></div>
</div>
</div>
</div>
