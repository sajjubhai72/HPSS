<?php 
    include('./Dashboard/teacher/includes/dbconnection.php');
    session_start();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>HPSS / Teacher Profile</title>
    ...
    <link rel="stylesheet" href="./Dashboard/teacher/css/style.css">
         ...
         <div class="row">
            ...
            <section class="py-5">
                <div class="container px-5 my-5">
                    ...
                    <form method="post" action="./Dashboard/teacher/search-result.php">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-column flex-xl-row text-center text-xl-start">
                            ...
                            <div class="ms-xl-4">
                                <div class="input-group mb-2">
                                    <input class="form-control esponsive" style="@media (max-width: 575.98px) {.form-control {width: 100%}}" type="text" placeholder="Search Teacher by Name or Subject" aria-label="Email address..." aria-describedby="button-newsletter" name="searchinput" required style="width:350px;" />
...
{               ?>  
                        ...
                        <div class="col-lg-2 mb-5">
                            <div class="card h-80 shadow border-0">
                                <img class="card-img-top h-80" src="./Dashboard/teacher/teacher/images/<?php echo $row->Picture;?>" alt="<?php  echo htmlentities($row->Name);?>" />
                                <div class="card-body p-2">
                                    <div class="badge bg-primary bg-gradient rounded-pill mb-3"><?php  echo htmlentities($row->TeacherSub);?></div>
                                    <a class="text-decoration-none link-dark stretched-link" href="./Dashboard/teacher/teacher-details.php?tid=<?php echo $row->ID;?>" target="_blank">
                                        <h5 class="card-title mb-3"><?php  echo htmlentities($row->Name);?></h5></a>
                                    <p class="card-text mb-0"><small>Registered Since HPSS</small></p>
                                </div>
   ...
   <script>
     ...
     //nepali date
      ...
      document.getElementById("nepali_date").innerHTML = full_date;
        ...
        <script src=".Dashboard/teacher/js/scripts.js"></script>
    </body>
    <script>
