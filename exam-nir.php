...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>HPSS / Exam Direction</title>
          ...
          <div class="col-lg-3">
            <div class="list-group">
              ...
              <a href="./notice.php" class="list-group-item ">Notice Board</a>   
               <a href="./checkResults.php" class="list-group-item "></i>Check Results</a>
               ...
               <a href="./exam-nir.php" class="list-group-item active"></i>परीक्षा निर्देशिका</a>
  ...
  <div class="jumbotron" style="background: #FFF;">
    <div class="row">
            ...
            <?php
              ...
              echo'<div><p><h4 style="color:#585454; margin-bottom: 20px; font-size: 20px;font-weight:700">' . $row['main_title'] . '</h4></p></div>';
          
                echo'<div style="margin-top: 20px"><p><a href="./dashboard/Notice-Dashboard/exam/' . $row['file'] .'" target="_blank"><i class="fa-solid fa-file-pdf" title=""></i>' . $row['title'] .'</a></p></div>';
              }?>
            </div>
    ...
    <div class="row">
       ...
       <div class="col-lg-5 col-sm-8 first">
          ...
          <div class="col-lg-2 col-sm-12 second">
              <!-- <p style="text-align:center;"><a href="./login.html" style="margin-left:20px;font-weight: bold;">User Login</a></p> -->
